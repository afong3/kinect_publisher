...
// Topics
static const std::string COLOR_TOPIC = "/kinect_color";
...
void Node::callback(const sensor_msgs::ImageConstPtr& color_msg, const sensor_msgs::ImageConstPtr& depth_msg)
        {
            ROS_INFO("hmmmm");
